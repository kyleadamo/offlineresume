  ...
  const options = [
    {
      ...
      description: 'Begin with a clean canvas and build your resume step by step',
      onClick: () => {
        createResume();
        navigate('/builder');
      },
    },
    {
      ...
      description: 'Upload a previously exported OfflineResume JSON file',
      onClick: () => navigate('/import?mode=json'),
    },
    {
      icon: ClipboardPaste,
      title: 'Convert my existing resume',
      description: 'Paste your resume text and we\'ll structure it for you',
