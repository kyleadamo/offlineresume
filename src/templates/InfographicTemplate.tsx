  ...
  const sectionRenderers: Record<string, () => React.ReactNode> = {
    ...
    experience: () => experience.length > 0 ? (
      <div key="experience" data-section="experience" className={`mb-6 ${sectionClass}`}>
        <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3 flex items-center gap-2">
          <span className="w-5 h-5 rounded flex items-center justify-center text-accent-foreground" style={{ backgroundColor: 'hsl(243, 75%, 59%)' }}><Briefcase className="w-3 h-3" /></span>
          Experience
        </h3>
    ...
    education: () => education.length > 0 ? (
      <div key="education" data-section="education" className={`mb-6 ${sectionClass}`}>
        <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3 flex items-center gap-2">
          <span className="w-5 h-5 rounded flex items-center justify-center text-accent-foreground" style={{ backgroundColor: 'hsl(243, 75%, 59%)' }}><GraduationCap className="w-3 h-3" /></span>
          Education
        </h3>
        <div className="space-y-3">
          {education.map((edu) => (
